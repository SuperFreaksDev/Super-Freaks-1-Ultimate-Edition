...
draw_sprite_parallax_x(spr_background_canyon_mountains_back,, _view_x1, view_height_get(), 2);
draw_sprite_parallax_x(spr_background_canyon_mountains_front,, _view_x1, view_height_get(), 1.5);
