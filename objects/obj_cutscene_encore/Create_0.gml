...
//Anti Freaks
cutscene_segment_set(0, "Superior: 'Well, what a surprise! It appears you were able to find all of our trophies afterall.'", spr_cutscene_placeholder,,, msc_cutscene_normal);
...
cutscene_segment_set(2, "'Now what do we do???'");
cutscene_segment_set(3, "Negative Quincy: 'I don't know, this was your stupid idea!'");
...
cutscene_segment_set(6, "");
//Exciting Encore
cutscene_segment_set(7, "Superior: 'Step inside our dome of torment--I mean uh, fun for a delightful time!'");
