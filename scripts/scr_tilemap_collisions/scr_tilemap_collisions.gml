#region Left
	...
	function collision_tile_slope_left(_x1 = x, _x2 = _x1, _y = y, _slope_only = false, _collide = true, _tilemap, _tile_data_array = global.tile_data_array_level, _check_semi_solid = true)
	{
		var _cell_y = clamp(_y, 0, room_height - 1) >> TILE_SIZE_DIV;
		var _cell_x1 = clamp(_x1, 0, room_width - 1) >> TILE_SIZE_DIV;
		var _cell_x2 = clamp(_x2, 0, room_width - 1) >> TILE_SIZE_DIV;
		var _cell_x, _cell_x_true;
		...
		for (_cell_x_true = _cell_x2; _cell_x_true >= _cell_x1; --_cell_x_true)
		{
			_cell_x = _cell_x_true;
	...
	/// @param _tile_data_array = global.tile_data_array_level
	/// @param {Boolean} _check_semi_solid = true
	function collision_tile_flat_left(_x1 = x, _x2 = x, _y1 = y, _y2 = y, _collide = true, _tilemap, _tile_data_array = global.tile_data_array_level, _check_semi_solid = true)
	{
		var _cell_x, _cell_y;
		...
		var _cell_y1 = clamp(_y1, 0, room_height - 1) >> TILE_SIZE_DIV;
		var _cell_y2 = clamp(_y2, 0, room_height - 1) >> TILE_SIZE_DIV;
			...
			for (_cell_y = _cell_y1; _cell_y <= _cell_y2; ++_cell_y)
			{
				...
				switch (_tile_data[tile_data.shape])
				{
					...
					case tile_shapes.AABB:
						...
						if (rectangle_in_rectangle(_x1, _y1, _x2, _y2, _tile_x1, _tile_y1, _tile_x2, _tile_y2))
						{
							if (_collide)
							{
								_new_pos = _tile_x2;
...
#region Up
	...
	/// @param _tile_data_array = global.tile_data_array_level
	/// @param {Boolean} _check_semi_solid = true
	function collision_tile_slope_up(_x = x, _y1 = y, _y2 = _y1, _slope_only = false, _collide = true, _tilemap, _tile_data_array = global.tile_data_array_level, _check_semi_solid = true)
	{
		var _cell_x = clamp(_x, 0, room_width - 1) >> TILE_SIZE_DIV;
		var _cell_y1 = clamp(_y1, 0, room_height - 1) >> TILE_SIZE_DIV;
		var _cell_y2 = clamp(_y2, 0, room_height - 1) >> TILE_SIZE_DIV;
		var _cell_y, _cell_y_true;
	...
	/// @param _tile_data_array = global.tile_data_array_level
	/// @param {Boolean} _check_semi_solid = true
	function collision_tile_flat_up(_x1 = x, _x2 = x, _y1 = y, _y2 = y, _collide = true, _tilemap, _tile_data_array = global.tile_data_array_level, _check_semi_solid = true)
	{
		var _cell_x, _cell_y;
...
#region Right
	...
	/// @param _tile_data_array = global.tile_data_array_level
	/// @param {Boolean} _check_semi_solid = true
	function collision_tile_slope_right(_x1 = x, _x2 = _x1, _y = y, _slope_only = false, _collide = true, _tilemap, _tile_data_array = global.tile_data_array_level, _check_semi_solid = true)
	{
		var _cell_y = clamp(_y, 0, room_height - 1) >> TILE_SIZE_DIV;
		var _cell_x1 = clamp(_x1, 0, room_width - 1) >> TILE_SIZE_DIV;
		var _cell_x2 = clamp(_x2, 0, room_width - 1) >> TILE_SIZE_DIV;
		...
		for (_cell_x_true = _cell_x1; _cell_x_true <= _cell_x2; ++_cell_x_true)
		{
			_cell_x = _cell_x_true;
			_tile_data = _tile_data_array[(tilemap_get(_tilemap, _cell_x, _cell_y) & tile_index_mask)];
	...
	/// @param _tile_data_array = global.tile_data_array_level
	/// @param {Boolean} _check_semi_solid = true
	function collision_tile_flat_right(_x1 = x, _x2 = x, _y1 = y, _y2 = y, _collide = true, _tilemap, _tile_data_array = global.tile_data_array_level, _check_semi_solid = true)
	{
		var _cell_x, _cell_y;
			...
			for (_cell_y = _cell_y1; _cell_y <= _cell_y2; ++_cell_y)
			{
				...
				switch (_tile_data[tile_data.shape])
				{
					...
					case tile_shapes.line:
						...
						if (rectangle_in_rectangle(_x1, 0, _x2, 0, _new_pos, 0, _new_pos, 0))
						{
							if (_collide)
								_collision = true;
							else
...
#region Down
	...
	/// @param _tile_data_array = global.tile_data_array_level
	/// @param {Boolean} _check_semi_solid = true
	function collision_tile_slope_down(_x = x, _y1 = y, _y2 = _y1, _slope_only = false, _collide = true, _tilemap, _tile_data_array = global.tile_data_array_level, _check_semi_solid = true)
	{
		var _cell_x = clamp(_x, 0, room_width - 1) >> TILE_SIZE_DIV;
		var _cell_y1 = clamp(_y1, 0, room_height - 1) >> TILE_SIZE_DIV;
		var _cell_y2 = clamp(_y2, 0, room_height - 1) >> TILE_SIZE_DIV;
	...
	/// @param _tile_data_array = global.tile_data_array_level
	/// @param {Boolean} _check_semi_solid = true
	function collision_tile_flat_down(_x1 = x, _x2 = x, _y1 = y, _y2 = y, _collide = true, _tilemap, _tile_data_array = global.tile_data_array_level, _check_semi_solid = true)
	{
		var _cell_x, _cell_y;
			...
			for (_cell_x = _cell_x1; _cell_x <= _cell_x2; ++_cell_x)
			{
				...
				switch (_tile_data[tile_data.shape])
				{
					...
					case tile_shapes.line:
						...
						if (rectangle_in_rectangle(0, _y1, 0, _y2, 0, _new_pos, 0, _new_pos))
						{
							if (_collide)
								_collision = true;
							else
