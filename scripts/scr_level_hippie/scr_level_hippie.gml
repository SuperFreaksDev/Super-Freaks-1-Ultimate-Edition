/// @function tile_data_array_level_hippie
function tile_data_array_level_hippie()
{
	...
	tile_data_set(_tile_data_array, 44, collider_behaviors_solid.hazard, tile_solidity.solid_flat, true, true, true, true,,,,,, ANGLE_FLAT, 0); //Spikeball
	tile_data_set(_tile_data_array, 45, collider_behaviors_solid.hazard, tile_solidity.solid_flat, true, true, true, true,,,,,, ANGLE_FLAT, 0); //Spikeball
	tile_data_set(_tile_data_array, 46, collider_behaviors_solid.hazard, tile_solidity.solid_flat, true, true, true, true,,,,,, ANGLE_FLAT, 0); //Spikeball
	tile_data_set(_tile_data_array, 47, collider_behaviors_solid.hazard, tile_solidity.solid_flat, true, true, true, true,,,,,, ANGLE_FLAT, 0); //Spikeball
	tile_data_set(_tile_data_array, 48, collider_behaviors_solid.hazard, tile_solidity.solid_flat, true, true, true, true,,,,,, ANGLE_FLAT, 0); //Spikeball
	tile_data_set(_tile_data_array, 49, collider_behaviors_solid.hazard, tile_solidity.solid_flat, true, true, true, true,,,,,, ANGLE_FLAT, 0); //Spikeball
	tile_data_set(_tile_data_array, 50, collider_behaviors_solid.hazard, tile_solidity.solid_flat, true, true, true, true,,,,,, ANGLE_FLAT, 0); //Spikeball
	tile_data_set(_tile_data_array, 51, collider_behaviors_solid.hazard, tile_solidity.solid_flat, true, true, true, true,,,,,, ANGLE_FLAT, 0); //Spikeball
	tile_data_set(_tile_data_array, 52, collider_behaviors_solid.hazard, tile_solidity.solid_flat, true, true, true, true,,,,,, ANGLE_FLAT, 0); //Spikeball
	tile_data_set(_tile_data_array, 53, collider_behaviors_solid.hazard, tile_solidity.solid_flat, true, true, true, true,,,,,, ANGLE_FLAT, 0); //Spikeball
}
