...
function tile_data_array_level_ice()
{
	...
	tile_data_set(_tile_data_array, 83, collider_behaviors_solid.ice, tile_solidity.solid_flat, false, true, false, false,,,,,, 0, 0); //Floor Semi Solid Single
	tile_data_set(_tile_data_array, 84, collider_behaviors_solid.ice, tile_solidity.solid_flat, false, true, false, false,,,,,, 0, 0); //Floor Semi Solid Left Corner
	tile_data_set(_tile_data_array, 85, collider_behaviors_solid.ice, tile_solidity.solid_slope, false, true, false, false,,,,,, 0, 0); //Floor Semi Solid Middle
	tile_data_set(_tile_data_array, 86, collider_behaviors_solid.ice, tile_solidity.solid_flat, false, true, false, false,,,,,, 0, 0); //Floor Semi Solid Right Corner
