/// @function tile_data_array_level_ice
function tile_data_array_level_ice()
{
	...
	tile_data_set(_tile_data_array, 43, collider_behaviors_solid.hazard, tile_solidity.solid_flat, true, true, true, true,,,,,, ANGLE_FLAT, 0); //Spikeball
	
	//Ice Tiles
	tile_data_set(_tile_data_array, 50, collider_behaviors_solid.ice, tile_solidity.solid_flat, true, true, true, true,,,,,, ANGLE_FLAT, 0); //Block Single
	tile_data_set(_tile_data_array, 51, collider_behaviors_solid.ice, tile_solidity.solid_flat, true, true, false, true,,,,,, ANGLE_FLAT, 0); //Block Horizontal Left
	tile_data_set(_tile_data_array, 52, collider_behaviors_solid.ice, tile_solidity.solid_flat, false, true, false, true,,,,,, ANGLE_FLAT, 0); //Block Horizontal Middle
	tile_data_set(_tile_data_array, 53, collider_behaviors_solid.ice, tile_solidity.solid_flat, false, true, true, true,,,,,, ANGLE_FLAT, 0); //Block Horizontal Right
	tile_data_set(_tile_data_array, 54, collider_behaviors_solid.ice, tile_solidity.solid_flat, true, true, true, false,,,,,, ANGLE_FLAT, 0); //Block Vertical Top
	tile_data_set(_tile_data_array, 55, collider_behaviors_solid.ice, tile_solidity.solid_flat, true, false, true, false,,,,,, ANGLE_FLAT, 0); //Block Vertical
	tile_data_set(_tile_data_array, 56, collider_behaviors_solid.ice, tile_solidity.solid_flat, true, false, true, true,,,,,, ANGLE_FLAT, 0); //Block Vertical Bottom
	tile_data_set(_tile_data_array, 57, collider_behaviors_solid.ice, tile_solidity.solid_flat, true, true, false, false,,,,,, ANGLE_FLAT, 0); //Floor Left Corner
	tile_data_set(_tile_data_array, 58, collider_behaviors_solid.ice, tile_solidity.solid_slope, false, true, false, false,,,,,, 0, 0); //Floor
	tile_data_set(_tile_data_array, 59, collider_behaviors_solid.ice, tile_solidity.solid_flat, false, true, true, false,,,,,, ANGLE_FLAT, 0); //Floor Right Corner
	tile_data_set(_tile_data_array, 60, collider_behaviors_solid.ice, tile_solidity.solid_flat, true, false, false, true,,,,,, ANGLE_FLAT, 0); //Ceiling Left Corner
	tile_data_set(_tile_data_array, 61, collider_behaviors_solid.ice, tile_solidity.solid_slope, false, false, false, true,,,,,, 180, 0); //Ceiling
	tile_data_set(_tile_data_array, 62, collider_behaviors_solid.ice, tile_solidity.solid_flat, false, false, true, true,,,,,, ANGLE_FLAT, 0); //Ceiling Right Corner
	tile_data_set(_tile_data_array, 63, collider_behaviors_solid.ice, tile_solidity.solid_slope, true, false, false, false,,,,,, 90, 0); //Wall - Left
	
	tile_data_set(_tile_data_array, 64, collider_behaviors_solid.ice, tile_solidity.solid_slope, false, false, true, false,,,,,, 270, 0); //Wall - Right
	tile_data_set(_tile_data_array, 69, collider_behaviors_non_solid.floor_top, tile_solidity.NA, false, false, false, false); //Slope 45 Degrees Bottom Left to Top Right - Top
	tile_data_set(_tile_data_array, 70, collider_behaviors_solid.ice, tile_solidity.solid_slope, false, true, false, false, tile_shapes.line, 0, 31, 31, 0); //Slope 45 Degrees Bottom Left to Top Right
	tile_data_set(_tile_data_array, 71, collider_behaviors_non_solid.NA, tile_solidity.solid_support, false, true, false, false); //Slope 45 Degrees Bottom Left to Top Right - Support
	tile_data_set(_tile_data_array, 72, collider_behaviors_non_solid.NA, tile_solidity.solid_support, false, true, false, false); //Slope 315 Degrees Top Left to Bottom Right - Support
	tile_data_set(_tile_data_array, 73, collider_behaviors_solid.ice, tile_solidity.solid_slope, false, true, false, false, tile_shapes.line, 0, 0, 31, 31); //Slope 315 Degrees Top Left to Bottom Right
	tile_data_set(_tile_data_array, 74, collider_behaviors_non_solid.floor_top, tile_solidity.NA, false, false, false, false); //Slope 315 Degrees Top Left to Bottom Right - Top
	tile_data_set(_tile_data_array, 75, collider_behaviors_non_solid.floor_top, tile_solidity.NA, false, false, false, false); //Slope 22.5 Degrees Bottom Left to Top Right - Top
	tile_data_set(_tile_data_array, 76, collider_behaviors_solid.ice, tile_solidity.solid_slope, false, true, false, false, tile_shapes.line, 0, 31, 31, 16); //Slope 22.5 Degrees Bottom Left to Top Right (1/2)
	tile_data_set(_tile_data_array, 77, collider_behaviors_solid.ice, tile_solidity.solid_slope, false, true, false, false, tile_shapes.line, 0, 15, 31, 0); //Slope 22.5 Degrees Bottom Left to Top Right (2/2)
	tile_data_set(_tile_data_array, 78, collider_behaviors_non_solid.NA, tile_solidity.solid_support, false, true, false, false); //Slope 22.5 Degrees Bottom Left to Top Right - Support
	tile_data_set(_tile_data_array, 79, collider_behaviors_non_solid.NA, tile_solidity.solid_support, false, true, false, false); //Slope 337.5 Degrees Bottom Left to Top Right - Support
	
	tile_data_set(_tile_data_array, 80, collider_behaviors_solid.ice, tile_solidity.solid_slope, false, true, false, false, tile_shapes.line, 0, 0, 31, 15); //Slope 337.5 Degrees Top Left to Bottom Right (1/2)
	tile_data_set(_tile_data_array, 81, collider_behaviors_solid.ice, tile_solidity.solid_slope, false, true, false, false, tile_shapes.line, 0, 16, 31, 31); //Slope 337.5 Degrees Top Left to Bottom Right (2/2)
	...
	tile_data_set(_tile_data_array, 83, collider_behaviors_solid.ice, tile_solidity.solid_flat, false, collider_solidity.semi_solid, false, false,,,,,, 0, 0); //Floor Semi Solid Single
	tile_data_set(_tile_data_array, 84, collider_behaviors_solid.ice, tile_solidity.solid_flat, false, collider_solidity.semi_solid, false, false,,,,,, 0, 0); //Floor Semi Solid Left Corner
	tile_data_set(_tile_data_array, 85, collider_behaviors_solid.ice, tile_solidity.solid_slope, false, collider_solidity.semi_solid, false, false,,,,,, 0, 0); //Floor Semi Solid Middle
	tile_data_set(_tile_data_array, 86, collider_behaviors_solid.ice, tile_solidity.solid_flat, false, collider_solidity.semi_solid, false, false,,,,,, 0, 0); //Floor Semi Solid Right Corner
	...
	tile_data_set(_tile_data_array, 90, collider_behaviors_non_solid.floor_top, tile_solidity.NA, false, false, false, false); //Floor Right Corner - Top
}
