...
function museum_init()
{
	...
	#region Character Cards
		...
		{
			return level_complete_get(level_ids.level_ludicrous_barrel);
		});
		...
		museum_character_create(26,, "Milk Man", "A milk bottle robot who, get this, is sour. He just wants to sleep and watch TV, and primarily mumbles under his breath. He will fight you pretty intensely just to make sure you won't bother him again.", function()
		{
			return level_complete_get(level_ids.level_crazy_boss);
		});
		museum_character_create(27,, "Mega Klaw", "A robot far stronger than even base level Kranion, and with the persona of a wrestler! Luckily, he's too nice and friendly to be malicious. He just likes to show off his strength.", function()
		{
			return level_complete_get(level_ids.level_ludicrous_boss);
		});
		museum_character_create(28,, "Larry McPeel", "A distant cousin of the Super Freaks. He isn't a bad guy, but he uses Unlimit Energy to do irritating and sometimes life threatening pranks. Kranion frequently recruits him, but even he gets annoyed with Larry!", function()
		{
			return level_complete_get(level_ids.level_insane_boss);
		});
		museum_character_create(29,, "Francis", "Of all of Kranion's friends, Francis is the most screwed up. He likes starting fires more than the guy actually made of fire! A favorite hobby of his is to hypnotize people and creatures into doing stupid things for his own amusement.", function()
		{
	...
	#region Cutscenes
		...
		museum_cutscene_create(12,, "Credits", rm_cutscene_credits, function()
		{
			return level_complete_get(level_ids.level_stadium);
		});
	#endregion
